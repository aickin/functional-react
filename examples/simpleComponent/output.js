...
var _InfoTextJs = require("./InfoText.js");

var _InfoTextJs2 = _interopRequireDefault(_InfoTextJs);

var getInitialState = function getInitialState() {
	return { buttonPushes: 0 };
};

var incrementPushes = function incrementPushes(_ref, setState) {
	var state = _ref.state;

	setState({ buttonPushes: state.buttonPushes + 1 });
};

var render = function render(_ref2, handler) {
	var state = _ref2.state;

	return _react2["default"].createElement(
		"div",
		null,
		_react2["default"].createElement(_InfoTextJs2["default"], { buttonPushes: state.buttonPushes }),
		_react2["default"].createElement(
			"button",
			{ onClick: handler(incrementPushes) },
			"Push Me"
		)
	);
};

exports["default"] = (0, _indexJs2["default"])({ render: render, getInitialState: getInitialState });
module.exports = exports["default"];

},{"../../index.js":3,"./InfoText.js":2,"react":159}],2:[function(require,module,exports){
"use strict";
...
exports["default"] = (0, _indexJs2["default"])({ render: render });
module.exports = exports["default"];

},{"../../index.js":3,"react":159}],3:[function(require,module,exports){
"use strict";
...
exports["default"] = function (_ref) {
	...
	var getDefaultProps = _ref.getDefaultProps;
	var propTypes = _ref.propTypes;
	var displayName = _ref.displayName;
	var componentWillMount = _ref.componentWillMount;
	var componentDidMount = _ref.componentDidMount;
	var componentWillReceiveProps = _ref.componentWillReceiveProps;
	var shouldComponentUpdate = _ref.shouldComponentUpdate;
	var componentWillUpdate = _ref.componentWillUpdate;
	var componentDidUpdate = _ref.componentDidUpdate;
	var componentWillUnmount = _ref.componentWillUnmount;
	...
	if (render) {
		componentSpec.render = function () {
			...
			var handler = function handler(impl) {
				return function (e) {
					impl({ props: _this.props, state: _this.state }, _this.setState.bind(_this));
				};
			};
	...
	return _react2["default"].createClass(componentSpec);
};
...
var _FullComponent = require("./FullComponent");

var _FullComponent2 = _interopRequireDefault(_FullComponent);

document.addEventListener("DOMContentLoaded", function (event) {
	_react2["default"].render(_react2["default"].createElement(_FullComponent2["default"], null), document.getElementById("main"));
});

},{"./FullComponent":1,"react":159}]},{},[160]);
