...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}var _react=require("react"),_react2=_interopRequireDefault(_react),_FullComponent=require("./FullComponent"),_FullComponent2=_interopRequireDefault(_FullComponent);document.addEventListener("DOMContentLoaded",function(e){_react2["default"].render(_react2["default"].createElement(_FullComponent2["default"],null),document.getElementById("main"))});

},{"./FullComponent":2,"react":160}],2:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}Object.defineProperty(exports,"__esModule",{value:!0});var _react=require("react"),_react2=_interopRequireDefault(_react),_indexJs=require("../../index.js"),_indexJs2=_interopRequireDefault(_indexJs),_InfoTextJs=require("./InfoText.js"),_InfoTextJs2=_interopRequireDefault(_InfoTextJs),getInitialState=function(){return{buttonPushes:0}},incrementPushes=function(e,t){var r=e.state;t({buttonPushes:r.buttonPushes+1})},render=function(e,t){var r=e.state;return _react2["default"].createElement("div",null,_react2["default"].createElement(_InfoTextJs2["default"],{buttonPushes:r.buttonPushes}),_react2["default"].createElement("button",{onClick:t(incrementPushes)},"Push Me"))};exports["default"]=_indexJs2["default"]({render:render,getInitialState:getInitialState}),module.exports=exports["default"];

},{"../../index.js":4,"./InfoText.js":3,"react":160}],3:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}Object.defineProperty(exports,"__esModule",{value:!0});var _react=require("react"),_react2=_interopRequireDefault(_react),_indexJs=require("../../index.js"),_indexJs2=_interopRequireDefault(_indexJs),render=function(e){var r=e.props;return _react2["default"].createElement("div",null,"The button has been pushed ",r.buttonPushes," time(s)")};exports["default"]=_indexJs2["default"]({render:render}),module.exports=exports["default"];

},{"../../index.js":4,"react":160}],4:[function(require,module,exports){
"use strict";function _interopRequireDefault(t){return t&&t.__esModule?t:{"default":t}}Object.defineProperty(exports,"__esModule",{value:!0});var _react=require("react"),_react2=_interopRequireDefault(_react);exports["default"]=function(t){var e=t.render,o=t.getInitialState,s=t.getDefaultProps,n=t.propTypes,p=t.displayName,r=t.componentWillMount,i=t.componentDidMount,a=t.componentWillReceiveProps,u=t.shouldComponentUpdate,c=t.componentWillUpdate,l=t.componentDidUpdate,d=t.componentWillUnmount,f={};return e&&(f.render=function(){var t=this,o=function(e){return function(o){e({props:t.props,state:t.state},t.setState.bind(t))}};return e({props:this.props,state:this.state},o)}),o&&(f.getInitialState=function(){return o()}),s&&(f.getDefaultProps=function(){return s()}),n&&(f.propTypes=n),p&&(f.displayName=p),r&&(f.componentWillMount=function(){r({props:this.props,state:this.state},this.setState.bind(this))}),i&&(f.componentDidMount=function(){i({props:this.props,state:this.state})}),a&&(f.componentWillReceiveProps=function(t){a({props:this.props,state:this.state},t,this.setState.bind(this))}),u&&(f.shouldComponentUpdate=function(t,e){return u({props:this.props,state:this.state},{props:t,state:e})}),c&&(f.componentWillUpdate=function(t,e){c({props:this.props,state:this.state},{props:t,state:e})}),l&&(f.componentDidUpdate=function(t,e){l({props:this.props,state:this.state},{props:t,state:e})}),d&&(f.componentWillUnmount=function(){d({props:this.props,state:this.state})}),_react2["default"].createClass(f)},module.exports=exports["default"];
